...
public class EmployeeControllerTest {
    ...
    @Test
    void getMaterialsByEmployeeId_ExistingEmployeeId_ReturnsOkAndListOfMaterials() throws Exception {
        String employeeId = "123";
        MaterialIssue materialIssue = new MaterialIssue();
        materialIssue.setEmployeeId(employeeId);
        materialIssue.setMaterialName("Laptop");
        List<MaterialIssue> expectedMaterials = Collections.singletonList(materialIssue);

        when(employeeService.getMaterialsByEmployeeId(employeeId)).thenReturn(expectedMaterials);
    ...
    @Test
    void getMaterialsByEmployeeId_NonExistingEmployeeId_ReturnsOkAndEmptyList() throws Exception {
