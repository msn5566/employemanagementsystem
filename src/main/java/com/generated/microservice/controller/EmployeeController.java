...
public class EmployeeController {
    ...
    public List<MaterialIssueDTO> getMaterialsIssuedToEmployee(@PathVariable String employeeId) {
        return materialIssueService.getMaterialsIssuedByEmployeeId(employeeId);
    }
}