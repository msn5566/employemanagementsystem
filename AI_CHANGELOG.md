...
*   **Feature Modified:**
    *   The user story has been changed from "Add new employee" to "Search employee by name".
    *   The actor has been changed from "HR manager" to "coordinator".
    *   The goal has been changed from adding an employee to quickly viewing employee details.
```
--- END ---
