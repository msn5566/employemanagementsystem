...
*   **Feature Modified:** The user story has been changed from "Add new employee" to "Search employee by name". The persona has changed from an HR manager to a coordinator.
```
--- END ---
