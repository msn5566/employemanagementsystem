...
Constraints: Must be accessible to administrators only.
Logic: Retrieve all material issue records associated with the given employee ID and present them in a readable format.
