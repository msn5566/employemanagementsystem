...
Constraints:
*   Implemented in Java 21 using Spring Boot 3.5.*
...
*   Includes GitHub Actions CI workflow for build, test, and Docker image creation.
Logic: The system should retrieve employee details from the MongoDB database based on the provided employee name. The search should be case-insensitive or provide options for exact or partial matches. The retrieved employee details should be displayed to the coordinator.
