...
---
**Date:** 2025-08-05 18:40:00
**Branch:** feature/AG-18_20250805183821
---
...
Constraints: Must use the provided GitHub repository (employemanagementsystem) on the development branch.
Logic: Create a POJO. Map data from source.xml to the POJO according to the mappings defined in mapping_with_validation.json, ensuring the output structure matches expected_target.xml.
