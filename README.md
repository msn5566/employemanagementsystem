...
---
**Date:** 2025-07-30 19:37:20
**Branch:** feature/AG-18_20250730193641
---
...
Output: A list of all materials issued to the specified employee, including details such as material name, issue date, and any relevant notes.
Constraints: Only accessible to users with admin privileges.
Logic: Retrieve and display material assignment records associated with the given employee ID.
