...
---
**Date:** 2025-07-25 13:06:36
**Branch:** feature/AG-14_20250725130606
---
...
* Must provide Dockerfile for containerization.
* Should include GitHub Actions CI workflow for build, test, and Docker image creation.
Logic: Implement a mechanism to compare the input photo against stored employee photos and return a list of employees whose photos match.
